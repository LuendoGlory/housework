    ...
    return (
        <div className="wrapper">
            ...
            <p>
                ...
                Si lors de votre dernière connexion vous n'étiez pas déconnecter, vous devez cliquer sur le menu <strong>Services</strong> en haut pour acceder directement aux services                           
            </p>
        </div>
    );
};
