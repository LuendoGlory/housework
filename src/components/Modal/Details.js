...
const Details = ({detail,close,setClose}) => {
    ...
    console.log("details from Details qdresse components",telephone,commune,zone,quartier,avenue,numero);
        ...
        <div className="modalBackground1" style={{display:close}}>
                <div className="modalContainer1">
                    ...
                    <h1>DETAILS DU COMMANDE</h1>
                        ...
                        <p>Adresse du client: {commune +`,` +zone+ `,`+quartier +`,`+avenue +`,` +numero}</p>
                        <p>Date: {date}</p>
